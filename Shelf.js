...
//extends in x by -0.5 * this.width, 0.5 * this.width
//extends in y by -0.5 * this.flatThickness, 0.5 * this.flatThickness
//extends in z by -0.5 * this.depth, 0.5 * this.depth
...
Shelf.prototype.addIntersectedBook = function (bookIndex) {
  ...
  var y = range.minY + 0.5 * this.flatThickness + 0.5 * book.height;

  //set the z coordinate
  var z = range.minZ + 0.5 * this.depth + 0.5 * book.depth;
